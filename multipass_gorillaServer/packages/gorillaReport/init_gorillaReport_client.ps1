...
#Gorilla Server DNS Name. Añadir puerto si no es el 443, recomendable en entornos de pruebas.
...
# 3.2 - descarga de ficheros (usando certificado y powershell 7)
$HASH=''
...
$outputFile1 = 'C:\Users\luivelmor\gorillaReport\modules\python_gorilla_parser\main.py'

$file2 = "http://$gorillaserver//packages/gorillaReport/modules/python_gorilla_parser/my_functions.py"
$outputFile2 = 'C:\Users\luivelmor\gorillaReport\modules\python_gorilla_parser\my_functions.py'
...
$outputFile1 = 'C:\Users\luivelmor\gorillaReport\scripts\prepare_reports.ps1'

$file2 = "http://$gorillaserver//packages/gorillaReport/scripts/register_client.ps1"
$outputFile2 = 'C:\Users\luivelmor\gorillaReport\scripts\register_client.ps1'

$file3 = "http://$gorillaserver//packages/gorillaReport/scripts/send_report_pwsh7.ps1"
$outputFile3 = 'C:\Users\luivelmor\gorillaReport\scripts\send_report_pwsh7.ps1'

$file4 = "http://$gorillaserver//packages/gorillaReport/scripts/register_basic_info.ps1"
$outputFile4 = 'C:\Users\luivelmor\gorillaReport\scripts\register_basic_info.ps1'

if (!(Test-Path $file1)) { Invoke-WebRequest -Uri $file1 -OutFile $outputFile1 }
if (!(Test-Path $file2)) { Invoke-WebRequest -Uri $file2 -OutFile $outputFile2 }
if (!(Test-Path $file3)) { Invoke-WebRequest -Uri $file3 -OutFile $outputFile3 }
if (!(Test-Path $file4)) { Invoke-WebRequest -Uri $file4 -OutFile $outputFile4 }
